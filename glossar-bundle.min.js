...
G.dict.push({
    ...
    // v gie end
    {
        ...
        en: [
          ...
          ['perform a task', 'deliver a speech', 'utter words'],
          ['<em>law</em> execute a deed', 'conclude a contract'],
          ['be the material or components of', 'go to form'],
          'fix a price',
          ['prepare to go', 'set out', 'proceed'],
          'draw up a document',
          ['earn', 'gain money', 'win something'],
          'prepare a bed for use',
          ['draw a distiction', 'raise a difficulty'],
...
G.dict.push({
    ...
    sc: 'gate',
    sc_alt: 'gait',
    def: [['a wey', 'a path', 'a road', 'a street (in a toun); kythes aft-times in steid names']],
    ...
    sc: 'mak',
    en: [['form', 'shape', 'a (distinctive) style of manufacture'], ['the action or process of manufacturing (an object) or developing (a character)']],
    ...
    sc: 'road',
    def: [['a braid route atween twa steids', 'a gate']],
