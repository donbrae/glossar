...
var GLOSSAR = (function() {
    ...
    var cfg = {
            ...
            threshold_non_hl: 1 // The minimum character length at which non-exact matches (i.e. those that aren't highlighted) will be shown. This is to prevent long lists of irrelevant results when short words (I, na, ay) are searched for
        },
        state = {
