...
$last_updatit = str_replace(
  array_keys($years),
  array_values($years),
  date("j F Y", filemtime("glossar-bundle.1591453395.min.js"))
);
...
<head>
    ...
    <meta property="og:title" content="Scots.sp"/>
    <meta property="og:description" content="Scots.app: translate atween Scots an English."/>
    <meta property="og:image" content=""/>

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site" content="@makforrit" />
    <meta name="twitter:title" content="Scots.app" />
    <meta name="twitter:description" content="Scots.app: translate atween Scots an English." />
    ...
    <link rel="stylesheet" href="app.1591453056.css">

    <script src="zepto.min.js"></script>
    <script src="fuse.basic.min.js"></script>

    <!-- Production JS bundle -->
    <script defer src="glossar-bundle.1591453395.min.js" onload="GLOSSAR.init()"></script>
...
<body>
    ...
    <main role="main" class="container">
        <h1 class="mt-5 text-center"><label for="searchTextbox">Scots.app<sup>beta</sup></label></h1>
        <section id="search">
    ...
    <footer class="footer">
        <div class="container">
            <span class="text-muted">Scots.app. <?php echo "Last updatit: $last_updatit"; ?>. Nae cookies.</span>
        </div>
    </footer>
</body>
