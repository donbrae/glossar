...
$last_updatit = str_replace(
  array_keys($years),
  array_values($years),
  date("j F Y", filemtime("glossar-bundle.1589736025.min.js"))
);
...
<head>
    ...
    <link rel="stylesheet" href="app.1589021342.css">

    <script src="zepto.min.js"></script>
    <script src="fuse.basic.min.js"></script>

    <!-- Production JS bundle -->
    <script defer src="glossar-bundle.1589736025.min.js" onload="GLOSSAR.init()"></script>
...
<body>
    ...
    <main role="main" class="container">
        <h1 class="mt-5 text-center"><label for="searchTextbox">Scots glossar<sup>beta</sup></label></h1>
        <section id="search">
