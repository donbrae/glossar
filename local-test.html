...
$last_updatit = str_replace(
  array_keys($years),
  array_values($years),
  date("j F Y", filemtime("glossar-bundle.1591826392.min.js"))
);
...
<head>
    ...
    <link rel="stylesheet" href="app.1591826607.css">

    <script src="zepto.min.js"></script>
    <script src="fuse.basic.min.js"></script>

    <!-- Production JS bundle -->
    <script defer src="glossar-bundle.1591826392.min.js" onload="GLOSSAR.init()"></script>
