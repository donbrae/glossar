        ...
        <section id="search">
            <div class="form-group form-inline justify-content-center">
                <div class="input-group w-75">
                    <input type="text" class="form-control mx-auto" id="searchTextbox" placeholder="Inpit Scots or English…" spellcheck="false" autofocus>
