...
<head>
    <title>Aboot - Scots.app (beta)</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/app.css?_=1595869746">
...
<body>
    <!-- Begin page content -->
    <header>
        <h1><a href="/">Scots glossar<sup>beta</sup></a></h1>
    </header>

    <main role="main" class="container">
        <h1 class="mt-5">Aboot</h2>

        <p>Scots.app is a quick-reference glossar that translates wirds and phrases atween Scots and English. It aye a beta and a lang gate aff frae bein a full dictionar, but we’r ettlin at makkin it better, sae check back aften if ye’r interestit in its development.</p>
        ...
        <h3>Featurs o this wab app</h3>

        <ol>
            <li>Leuk up vocabular in English or Scots uisin the ae text kistie</li>
            <li>See results as ye teep</li>
            <li>Inpit wirds uisin mair estaiblisht spellings alang wi some common mis-spellings</li>
            <li>Returns baith the Scots, and the English translate or a definition in Scots</li>
            <li>Gies recommendit pan-dialectal spelling(s), basic pronunciation and grammar, some info anent wird origin, alang wi ony common alternative spellings</li>
            <li>Audio o the wirds bein spoken in sindry byleids</li>
            <li>Twa-three example sentences for tae gie an idea of the wird in context</li>
            <li>URL per results set for easy skairin on social media, in messaging apps etc.</li>
            <li>Lichtwecht and accessible on dasktap, tablet and mobile.</li>
        </ol>

        <h3>Soorces (mair tae be eikit)</h3>
