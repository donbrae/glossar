...
<head>
    ...
    <meta property="og:title" content="Scots glossar<?php echo $title_append; ?>"/>
    ...
    <meta name="twitter:title" content="Scots glossar<?php echo $title_append; ?>" />
    ...
    <link rel="stylesheet" href="/app.css?_=1598801035">
        ...
        <section id="search">
            <div class="form-group form-inline justify-content-center">
                <div class="input-group">
                    <input type="text" class="form-control mx-auto" id="searchTextbox" placeholder="Inpit Scots or English…" spellcheck="false" maxlength="50">
                    <button class="btn bg-transparent fade" id="clear-value" disabled>
                        <!-- Credit: Paweł Kuna (@codecalm; tablericons.com) -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke-width="2.8" stroke="#8c8c8c" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="-4 -4 32 32">
            ...
            <div class="text-center">
                <button id="random" class="btn-link-gray btn-center">…or wale oot a wird allevolie</button>
            </div>

            <div id="results" class="fade"></div>

            <div class="text-center">
                <button id="btn-copy" class="btn-link-gray btn-center hide fade">Copy a link tae <span>this result|thir results</span></button>
            </div>

            <input type="text" id="field-copy" style="position: absolute; left: -9999px;">
